...
public class ControlLine {
	...
	/*public RoadMap addRoad(String name, Station firstStation, Station lastStation) throws RoadMapAlreadyExistException,
		...
		try {
			...
			throw new PathNotExistException("Path beetween station " + firstStation.getName() + " and station "
					+ lastStation.getName() + "don't exist (loop)");
		} catch (TerminusException e) {
			throw new PathNotExistException("Path beetween station " + firstStation.getName() + " and station "
					+ lastStation.getName() + "don't exist (terminus)");
		} catch (StationAlreadyExistInRoadMapException e) {
